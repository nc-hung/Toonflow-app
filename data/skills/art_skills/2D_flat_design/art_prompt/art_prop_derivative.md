# Đạo cụsinh trạng tháitạo · phong sổ tay

---

## 1 、sinh gốc 

1. **nối ** — Đạo cụtạo kiểu /ở tất cảtrạng tháigiữa trưng khác 
...
|---|---|---|---|
| mới  | tốt không 、thuần vật như mới  | tất cảĐạo cụ | mới 、tốt không 、thuần vật như mới  |
| ngày thường hàm  | 、đơn vật hóa  | thiết bị /thiết bị / | hàm 、đơn  |
...
| trạng thái | Mô tả | hàm Đạo cụ | Prompt |
|---|---|---|---|
|  | nhỏ /nhỏ cổng / | thiết bị //thiết bị  | 、đơn  |
|  | dẫn // | thiết bị //thiết bị  | 、đơn  |
|  | chỉ bộ phút/ | thiết bị //tin  | 、đơn  |

### 2.3 trạng thái

| trạng thái | Mô tả | hàm Đạo cụ | Prompt |
|---|---|---|---|
|  | vật vật đang  | thiết bị //tin  | 、vật  |
| / | vật 、 | /tin / | 、vật  |
| / | vật 、 | /tin / | 、đơn  |
| phát ánh /kích hoạt  | đơn phát ánh vật 、đơn ánh  | tin /thức thiết bị / | phát ánh 、đơn ánh  |
| gói /lưu  | hàm /gói  | tin // | gói 、đơn  |
...
|---|---|---|---|
| biệt  | thuần vật  → đơn gói vật  | gói  → đơn vật  | đơn cổng // |
|  | thuần vật  → đơn vật  |  → bảng mặt đơn  | đơn //nhân  |
|  | thuần vật  → đơn gói vật  | gói  → vật  | đơn mở // |
| thiết bị  | thuần vật  → đơn vật  |  → mặt vật  | đơn //cổng  |
| / | thuần vật chỉnh  → đơn vật  |  → phát vật  | đơn // |
...
```
cơ sở với {Đạo cụtên }thiết nối ảnh ，
...
đường mục sạch ，vật phútdẫn ，trạng tháitiết 
...
| R4 | Bắt buộcnối 「thuần giữa bối 」，không Ánh sáng，không  |
...
| X7 | thêm/sáng /cao ánh /lập thể hiệu quả  |
| X8 | trạng tháihóa với lời 、vật khu phútkhông sạch  |
