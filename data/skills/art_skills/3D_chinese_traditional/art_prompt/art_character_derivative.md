...
description: ngườisinh Tài nguyêntạo · sổ tay
metaData: art_skills
---

# ngườisinh Tài nguyêntạo · sổ tay
...
| L4 | ngoài /chính phục  | phong phục /phục /thường phục  |
| L5 | nối  | đầu ////tay  |

> **giới **：ngườisinh Tài nguyênchỉ gói  L0–L5 tầng cấp （phục hóa tạo ），không gói Đạo cụ（////tay giữ ）、Bối cảnh（trong /ngoài /ngày）、thái động tác vụ （thi chạy /trả /tay ）。nàynhững biệt với anh ấyTài nguyênLoại của 。
...
| mặt bộ đường kiếm  | 、、、vật nhắc  | （） |
| dẫn ngày thường đường kiếm  | ngày thường 、ngoài ra 、 | cơ sở （tự sạch ） |
| dẫn chính thức thức đường kiếm  | lớn 、、trùng cần trường hợp  | chính thức （） |
...
|---|---|---|
| sạch  | ngày thường 、、giữa  | dung sạch 、、sạch  |
|  | 、chính thức 、thực lực  | dung 、dạng 、vật  |
|  | sẽ 、động 、 | 、đuôi 、vật  |
| lớn  | lớn 、 | đẹp 、 |
| tiết ngày  | 、sẽ  | vật dẫn 、dung  |

### thông hàm （tất cảdung ）

| dự án |  | Prompt |
|---|---|---|
|  | PBR、tự  | PBR、tự ánh 、 và  |
...
|---|---|---|---|
| cao  | cao đĩa phát  + phát  | 、chính thức  | cao 、đĩa phát  |
| đôi  | đôi đúng 、ít nữ  | nămNhân vật | đôi 、ít nữ Phong cách |
|  | thấp 、 | ngày thường 、 | 、 |
| phát  | dài phát toàn 、tự  | giữa 、mật  | dài phát 、tự  |
| phát cao đuôi  | cao  | 、thi động  | cao đuôi 、 |
| nửa phát  | phát nửa  + sau phương phát  | ngày thường 、ra thi  | nửa 、tự phát  |

### nữ phát 

| dự án |  | Prompt |
|---|---|---|
| Phong cách | 、phục nối  | phát 、 |
|  |  +  +  | phát 、đầy đầu  |
|  | cao độ tạo mô 、tiết sạch  | cao độ 、 |

### nam tạo kiểu Loại

| tạo kiểu  | hàm  | Prompt |
|---|---|---|
| phát nửa  | ngày thường 、tài người | phát nửa 、phát  |
| toàn cao  | chính thức 、 | toàn cao 、phát  |
| phát  | mật 、 | phát 、dài phát như  |
| phát cao đuôi  | 、 | cao phát 、đuôi  |
...
|---|---|---|---|
| dài  | dài 、 | ngày thường 、giữa  | dài 、 |
| phục  | phục 、 | 、chính thức  | phục 、 |
| thường phục  | ngắn 、 | thi động 、 | thường phục 、ngắn  |
|  | mỏng trong 、vật  | trong 、gian  | 、rộng  |
| lớn  | 、tầng  |  | 、tầng  |
...
| dự án |  | Prompt |
|---|---|---|
| chính vật  | giữa truyền thống vật gọi Mặc định | giữa truyền thống vật gọi phục 、phục  |
|  |  +  + ánh mặt  | 、tiết  |
|  | lý Bắt buộcvượt sạch  | phục sạch 、lý vượt sạch  |
| bộ  | // | đẹp 、đầu có  |
| tầng lần  | nhiều tầng 、tầng lần phútdẫn  | nhiều tầng 、tầng lần phútdẫn  |

### nam phục 

| Phong cách | hàm  | Prompt |
|---|---|---|
| tài người | ngày thường 、 | tài người、dài  |
|  | 、 | 、 |
| phục  | 、 | phục 、chính thức phục  |
| thường phục  | 、mật  | thường phục 、Phong cách |
| phục  | chính thức 、 | phục 、 |
...
| Loại |  | Prompt |
|---|---|---|
| đầu  | 、không đơn mỏng  | đầu 、đầy đầu  |
|  | / | 、 |
|  | / | đẹp 、 |
|  | / | 、gian  |
| tay  | / | thông 、 |
...
|---|---|---|
| phát  | /、 | phát  |
|  | rộng /kèm  | rộng 、phútdẫn  |
|  | thông  | gian  |
| thiết bị  | //（Tùy chọn） | dài ở 、nửa  |
...
|---|---|---|---|---|
| giữa ngày thường  | sạch  | phát /nửa phát  | dài  | giữa  |
| lần  | sạch  | nửa phát / | dài  | giữa nhiều  |
| động  |  | nửa phát / | dài / | giữa  |
| chính thức  |  | cao  | phục  |  |
| gian mật  | sạch / | phát / |  |  |
| lớn  | lớn  | cao  |  |  |
| thi động  | （） | phát đuôi  | thường phục  |  |
...
>
> | khuyến độ  | phong 3Dcơ sở  |
> |---|---|
> | dung độ  | Mặc địnhsạch ；/thực lực /chính thức →；động /→；lớn /→lớn ；tiết ngày sẽ →tiết ngày  |
> | phát kiểu  | ngày thường /giữa →nửa phát hoặc ；/chính thức →cao ；mật /Ban đêm→phát ；/thi động →phát đuôi  |
> | phục  | cơ sở gọi ；tình Bối cảnh→dài ；thực lực /chính thức →phục ；thi động →thường phục ；PBRban đầu lưu giữ  |
> | nối độ  | ngày thường →giữa ；chính thức /→（phát ++）；mật →；thi động → |
> | cơ sở  | PBR+sáng cấp Ánh sángban đầu nối ；thể ánh trước với mặt  |
...
3DPhong cách，cao độ tạo mô ，PBR，phong 3D，sáng cấp Ánh sáng，
...
【L1·dung 】dựa theohàm dùng đường kiếm quyết định：{cơ sở //chính thức }；hàm  {dung Phong cách}, PBR, {}, {}, {},
【L2·phát kiểu 】{tạo kiểu Loại}, cao độ phát sạch , {phát Mô tả},
【L3+L4·phục 】{chính vật }{thức }, {}, {}, phục sạch , PBR,
【L5·nối 】{đầu }, {}, {}, {},
...
| R2 | phục Bắt buộchàm 「phục sạch  + PBR」 |
| R3 | nữ nối Bắt buộc「 + 」 |
...
| R10 | **Nghiêm cấmĐạo cụtác vụ **——không gói tay giữ /tác vụ （///），Đạo cụbiệt với lập Tài nguyênLoại |
...
| X12 | chưa phúttích hàm dùng đường kiếm thì trực tiếp hàm nối dung  |
