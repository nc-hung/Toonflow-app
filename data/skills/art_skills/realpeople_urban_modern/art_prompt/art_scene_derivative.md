# Bối cảnhsinh Tài nguyêntạo · đều sổ tay
...
5. **** — tất cảthể Bắt buộclưu giữ thật sáng ， 3D /CG động vẽ ；lưu lưu Ống kínhánh lý ánh 
...
| trong ngày gian  → trong gian  | rỗng gian kết cấu 、cụ  | chỉnh thể vật gọi hóa 、cộng đài /địa  |
...
```
Đô Thị Hiện Đạisinh Bối cảnhảnh ，cơ sở với tham chiếuảnh ，
...
| R8 | Bắt buộcgói sáng liên từ （real photography / photorealistic / RAW photo） |
| R9 | Bắt buộcgói Ống kínhánh （shallow depth of field / lens vignette / bokeh đến ít 1 ） |
| R10 | Bắt buộckèm có tự /hàm ，Nghiêm cấmtoàn mới không  của "CG " |
