/**
 * Toonflow AINhà cung cấpTemplate - DeepSeek
 * @version 2.1
 */
...
const vendor: VendorConfig = {
  ...
  name: "DeepSeek",
  description:
    "Giao diện chính thức của DeepSeek, hỗ trợ dòng mô hình V3/R1 và chế độ suy luận chuyên sâu (Chain of Thought).\n\n🔗 [Truy cập nền tảng DeepSeek](https://platform.deepseek.com/)",
  icon: "",
  inputs: [
    { key: "apiKey", label: "Khóa API (API Key)", type: "password", required: true },
    { key: "baseUrl", label: "Địa chỉ yêu cầu", type: "url", required: true, placeholder: "Ví dụ: https://api.deepseek.com" },
  ],
  inputValues: {
    apiKey: "",
